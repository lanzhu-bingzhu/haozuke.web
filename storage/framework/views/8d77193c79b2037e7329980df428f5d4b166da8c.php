					...
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover">
							...
							<ul class="dropDown-menu menu radius box-shadow">
								...
								<li><a href="#">切换账户</a></li>
								<li><a href="<?php echo e(route('quit')); ?>">退出</a></li>
							</ul>
						</li>
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<?php $__currentLoopData = $powers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $power): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php if($power['is_show'] == '1'): ?>
				<dl id="menu-article">
					<dt><i class="Hui-iconfont">&#xe616;</i> <?php echo e($power['power_name']); ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
					</dt>
					<dd>
						<ul>
							...
							<li><a data-href="<?php echo e(route($val['route_name'])); ?>" data-title="<?php echo e($val['power_name']); ?>" href="javascript:void(0)"><?php echo e($val['power_name']); ?></a></li>
							<?php endif; ?>
	...
	<section class="Hui-article-box">
		<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
			<div class="Hui-tabNav-wp">
				<ul id="min_title_list" class="acrossTab cl">
					<li class="active">
						<span title="我的桌面" data-href="<?php echo e(route('view/welcome')); ?>">我的桌面</span>
						<em></em>
					</li>
				</ul>
			</div>
		...
		<div id="iframe_box" class="Hui-article">
			<div class="show_iframe">
				...
				<iframe scrolling="yes" frameborder="0" src="<?php echo e(route('view/welcome')); ?>"></iframe>
			</div>
		</div>
	</section>
...
</html><?php /**PATH H:\phpstudy_pro\WWW\Level9\haozuke_test\resources\views/admin/index.blade.php ENDPATH**/ ?>