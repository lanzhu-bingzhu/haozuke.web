...
<body>
  ...
  <div class="loginWraper">
    <div id="loginform" class="loginBox">
      ...
      <?php endif; ?>
      <form class="form form-horizontal" action="<?php echo e(route('login/sign')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="row cl">
  ...
  <script>
    function get_code(obj) {
      ...
      $.ajax({
        type: "get",
        url: "<?php echo e(route('login/getCode')); ?>",
        dataType: "json",
        success: res => {
...
</html><?php /**PATH H:\phpstudy_pro\WWW\Level9\haozuke_test\resources\views/login/login.blade.php ENDPATH**/ ?>