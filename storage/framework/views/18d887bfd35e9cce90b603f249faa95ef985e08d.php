    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a href="javascript:;"
                    onclick="fangattr_add('添加房源信息','<?php echo e(route('view/fang-add')); ?>','','560')"
                ...
                <tr class="text-c">
                    ...
                    <td>
                        <a title="编辑" href="javascript:;"
                            onclick="fangattr_edit('房源信息编辑','<?php echo e(route('view/fang-add', ['id' => $val['id']])); ?>','<?php echo e($val['id']); ?>','','560')" class="ml-5" style="text-decoration:none">
