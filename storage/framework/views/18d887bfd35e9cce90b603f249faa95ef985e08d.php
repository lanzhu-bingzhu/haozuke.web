    ...
    <div class="page-container">
        <div class="text-c">
            <form class="Huiform" method="get" action="<?php echo e(route('view/fang-list')); ?>">
                <input type="text" class="input-text" style="width:250px" placeholder="房源名称" id="h" name="h" value="<?php echo e($h); ?>">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a href="javascript:;"
                    onclick="admin_add('添加房源信息','<?php echo e(route('view/fang-add')); ?>','','560')"
                    class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加房源信息
                </a>
                <a href="<?php echo e(route('view/fang-chart')); ?>" class="btn btn-success radius">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tbody>
                <?php $__currentLoopData = $fang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="text-c">
                    <td><input type="checkbox" class="checked" value="<?php echo e($val['id']); ?>" name=""></td>
                    <td><?php echo e($val['id']); ?></td>
                    <td><?php echo e($val['fang_name']); ?></td>
                    <td><?php echo e($val['fang_xiaoqu']); ?></td>
                    <td><?php echo e($val['fang_addr']); ?></td>
                    <td><?php echo e($val['fang_rent_class']); ?></td>
                    <td><?php echo e($val['fang_owner']); ?></td>
                    <td><?php echo e($val['fang_rent']); ?></td>
                    <td><?php echo e($val['fang_direction']); ?></td>
                    <td>
                        <?php if($val['fang_status'] == 0): ?>
						<span onclick="check_status_on(this, '<?php echo e($val['id']); ?>')" class="label label-success radius">未租</span>
                        <?php else: ?>
						<span onclick="check_status_off(this, '<?php echo e($val['id']); ?>')" class="label label-danger radius">已租</span>
                        <?php endif; ?>
                    </td>
                    <td>
                        <a title="编辑" href="javascript:;"
                            onclick="admin_edit('房源信息编辑','<?php echo e(route('view/fang-add', ['id' => $val['id']])); ?>','<?php echo e($val['id']); ?>','','560')" class="ml-5" style="text-decoration:none">
        ...
        */
        ...
        function admin_del(obj, id) {
            layer.confirm('确认要删除吗？', index => {
                $.ajax({
                    type: 'get',
                    url: '<?php echo e(route("fang/delete")); ?>',
                    data: { id },
                    dataType: 'json',
        ...
        function check_status_on(obj, id) {
            layer.confirm('确认切换成已租吗？', index => {
                $.ajax({
                    type: "get",
                    url: "<?php echo e(route('fang/status')); ?>",
                    data: { id },
                    dataType: "json",
                    success: res => {
                        if (res.code == 200) {
...
</html><?php /**PATH H:\phpstudy_pro\WWW\Level9\haozuke_test\resources\views/fang/fang-list.blade.php ENDPATH**/ ?>