...
<body>
    ...
    <div class="page-container">
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tbody>
                <?php $__currentLoopData = $notice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="text-c">
                    <td><input type="checkbox" class="checked" value="<?php echo e($val['id']); ?>" name=""></td>
                    <td><?php echo e($val->id); ?></td>
                    <td><?php echo e($val->owner->name); ?></td>
                    <td><?php echo e($val->renting_id); ?></td>
                    <td><?php echo e($val->dtime); ?></td>
                    <td><?php echo e($val->status); ?></td>
                    <td><?php echo e($val->cnt); ?></td>
                    <td>
...
</html><?php /**PATH H:\phpstudy_pro\WWW\Level9\haozuke_test\resources\views/notice/notice-list.blade.php ENDPATH**/ ?>