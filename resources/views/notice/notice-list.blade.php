    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a href="javascript:;"
                    onclick="admin_add('添加房源信息','{{route('view/notice-add')}}','','560')"
                ...
                <tr class="text-c">
                    ...
                    <td>
                        <a title="编辑" href="javascript:;"
                            onclick="admin_edit('房源信息编辑','{{route('view/notice-add', ['id' => $val['id']])}}','{{$val['id']}}','','560')" class="ml-5" style="text-decoration:none">
