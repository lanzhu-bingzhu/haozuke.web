	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			@foreach ($powers as $power)
				@if ($power['is_show'] == '1')
				<dl id="menu-article">
					<dt><i class="Hui-iconfont">&#xe616;</i> {{$power['power_name']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
					</dt>
					<dd>
						<ul>
							@foreach ($power['treenChildren'] as $val)
							@if ($val['is_show'] == '1')
							<li><a data-href="{{route($val['route_name'])}}" data-title="{{$val['power_name']}}" href="javascript:void(0)">{{$val['power_name']}}</a></li>
							@endif
							@endforeach	
						</ul>
					</dd>
	...
	<section class="Hui-article-box">
		<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
			<div class="Hui-tabNav-wp">
				<ul id="min_title_list" class="acrossTab cl">
					<li class="active">
						<span title="我的桌面" data-href="{{route('view/welcome')}}">我的桌面</span>
						<em></em>
					</li>
				</ul>
			</div>
		...
		<div id="iframe_box" class="Hui-article">
			<div class="show_iframe">
				...
				<iframe scrolling="yes" frameborder="0" src="{{route('view/welcome')}}"></iframe>
			</div>
		</div>
	</section>
